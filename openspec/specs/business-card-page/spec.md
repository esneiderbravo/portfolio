# business-card-page Specification

## Purpose

Serve a focused, mobile-first digital business card at `/card` with brand-consistent styling, bilingual content, large action shortcuts (save contact, book a call, WhatsApp, email, social, share), and shareable metadata — independent from the home page sections.
